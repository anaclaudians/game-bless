...
export const mockDatabase = {
  jogos: [
    { id: 'quem-sou-eu', nome: 'Adivinha quem?', tipo: 'dicas', cor: '#E0664B', capa: '/capa-quem-sou-eu.png', regras: 'Leia as dicas uma a uma. O jogador deve adivinhar o personagem bíblico descrito. Quanto menos dicas usar, melhor!' },
    { id: 'palavra-proibida', nome: 'Ação e Palavra', tipo: 'acao', cor: '#C25134', capa: '/capa-palavra-proibida.png', regras: 'Tente fazer sua equipe adivinhar a palavra principal da carta. ATENÇÃO: É proibido falar qualquer uma das outras 5 palavras listadas na carta!' },
    { id: 'quem-disse', nome: 'Quem falou?', tipo: 'quiz', cor: '#9E4733', capa: '/capa-quem-disse.png', regras: 'Leia o versículo bíblico apresentado na tela e selecione o autor correto da frase entre as quatro opções de resposta.' },
    { id: 'qual-versiculo-sou', nome: 'Enigma do Versículo', tipo: 'dicas', cor: '#D17A22', capa: '/capa-qual-versiculo-sou.png', regras: 'Adivinhe qual é o versículo ou Salmo descrito através de 3 pistas progressivas sobre o seu significado e conteúdo.' },
    { id: 'o-que-sou', nome: 'O Que É O Que É?', tipo: 'dicas', cor: '#9A5B43', capa: '/capa-o-que-sou.png', regras: 'Adivinhe qual objeto, animal ou local sagrado da Bíblia está sendo descrito com base em 3 pistas inteligentes.' },
    { id: 'quem-sabe-responde', nome: 'Mestres da Bíblia', tipo: 'quiz', cor: '#6B4F4F', capa: '/capa-quem-sabe-responde.png', regras: 'Um teste clássico de conhecimentos bíblicos gerais de múltipla escolha. Escolha a resposta certa entre as 4 alternativas.' },
    ...
    { id: 'quem-sou-eu-extreme', nome: 'Identidade oculta Extreme', tipo: 'dicas', cor: '#842E1B', capa: '/capa-quem-sou-eu-extreme.png', regras: 'Para estudiosos da Bíblia! Adivinhe o personagem com base em 3 pistas sobre detalhes obscuros ou pouco conhecidos das Escrituras.' },
    ...
    { id: 'familias-da-biblia', nome: 'Laços Bíblicos', tipo: 'quiz', cor: '#7A8B47', capa: '/capa-familias-da-biblia.png', regras: 'Teste seus conhecimentos sobre as linhagens, casamentos, parentescos e histórias das famílias que marcaram as Escrituras.' },
    { id: 'faz-sentido', nome: 'Lógica Bíblica', tipo: 'acao', cor: '#D15E84', capa: '/capa-faz-sentido.png', regras: 'Debate e conexão! Jogue cartas de conceitos físicos e veja se eles têm relação lógica com a carta no centro da mesa. Votem e gerenciem as 3 vidas locais de cada um dos 4 participantes.' },
    { id: 'desafio-versiculos', nome: 'Batalha de Versículos', tipo: 'quiz', cor: '#39A087', capa: '/capa-desafio-versiculos.png', regras: 'Complete a palavra ausente ou adivinhe o versículo-chave correto apresentado na pergunta de múltipla escolha.' }
  ],
  cartas: {
    // ==========================================
